...
class Tabs extends BaseComponent{
    ...
    constructor(rootElement){
        ...
        this.limiteTabsIndex = this.buttonElements.length - 1;
        this.bindEvents();
    }
    ...
    nextTab = () => {
        const newTabIndex = this.state.activeTabIndex === this.limiteTabsIndex
        ? 0
        : this.state.activeTabIndex + 1;
    ...
    lastTab = () => {
        this.activateTab(this.limiteTabsIndex);
    }
